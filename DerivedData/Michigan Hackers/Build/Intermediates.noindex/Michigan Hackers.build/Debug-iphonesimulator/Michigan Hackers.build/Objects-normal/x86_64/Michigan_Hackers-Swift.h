...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Michigan_Hackers",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Michigan_Hackers11AppDelegate")
...
SWIFT_CLASS("_TtC16Michigan_Hackers18CalendarController")
...
SWIFT_CLASS("_TtC16Michigan_Hackers8DateCell")
@interface DateCell : JTAppleCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC16Michigan_Hackers5Event")
...
SWIFT_CLASS("_TtC16Michigan_Hackers9EventCell")
...
@class GTLRCalendar_Events;
@class NSError;

SWIFT_CLASS("_TtC16Michigan_Hackers15EventController")
@interface EventController : UIViewController <GIDSignInDelegate, GIDSignInUIDelegate>
- (void)viewDidLoad;
...
@interface EventController (SWIFT_EXTENSION(Michigan_Hackers)) <IGListAdapterDataSource>
...
SWIFT_CLASS("_TtC16Michigan_Hackers22EventSectionController")
@interface EventSectionController : IGListSectionController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@interface NSObject (SWIFT_EXTENSION(Michigan_Hackers)) <IGListDiffable>
...
SWIFT_CLASS("_TtC16Michigan_Hackers22NotificationController")
...
SWIFT_CLASS("_TtC16Michigan_Hackers19ResourcesController")
...
SWIFT_CLASS("_TtC16Michigan_Hackers16TabBarController")
